...
def channel_capacity_per_user(G, u, signal_pow, precoding_index):
	"""
...
def system_capacity(G, signal_pow, precoding_index):
	"""
	...
	for u in range(ut_num):
		C += channel_capacity_per_user(G, u, signal_pow, precoding_index)
	return C / bs_num
