...
from data_generator.channel_generator_3d import single_channel_generator_3d
...
def place_ut():
    ...
    ut_dir -- np array in shape of (ut_num,) random direction uniformly sampled from [0,360)
    """
...
def assign(H, path_loss, ut_pos):
    ...
    """
    # For each antenna pair, add channels of all paths together
    H = np.sum(H, axis=2)
